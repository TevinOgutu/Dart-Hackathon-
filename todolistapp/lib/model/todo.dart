...
class ToDo {
  ...
  static List<ToDo> todoList() {
    ...
    return [
      ToDo(
          id: '1', todoText: 'Set up my IDE', isDone: true), // A completed task
      ToDo(
          id: '2',
          todoText: 'Install flutter',
          isDone: true), // A completed task
      ToDo(
          id: '3', todoText: 'Set up Github', isDone: true), // A completed task
      ToDo(id: '4', todoText: 'Create a flutter app'), // An incomplete task
      ToDo(id: '5', todoText: 'Submit my hackathon code'), // An incomplete task
      ToDo(id: '6', todoText: 'Pusblish my work'), // An incomplete task
    ];
  }
}
