      ...
      child: ListTile(
        ...
        trailing: Container(
          ...
          decoration: BoxDecoration(
            color: Color.fromARGB(255, 5, 230,
                238), // Set background color of the delete button container to red
            borderRadius: BorderRadius.circular(
                15), // Set rounded corners for the delete button container
          ),
          child: IconButton(
            onPressed: () {
              onDeleteItem(todo
            ...
            icon: Icon(
              Icons.delete,
              size: 18,
              color: Color.fromARGB(255, 92, 3, 236), // Set icon color to white
            ),
          ),
        ),
      ),
