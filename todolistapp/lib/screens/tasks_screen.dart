...
import 'package:todolistapp/model/todo.dart'; // Import ToDo model class
import 'package:todolistapp/widgets/todo_items.dart'; // Import ToDoItem widget
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 54, 12, 240),
